...
region_list, c_inv_sq_list, d_list = construct_ellipse_space(env)
...
#start_ix = find_ellipse_for_point(c_inv_sq_list, d_list, start)
#end_ix = find_ellipse_for_point(c_inv_sq_list, d_list, end)

# Find the first and last ellipse on the path from tracker to target
